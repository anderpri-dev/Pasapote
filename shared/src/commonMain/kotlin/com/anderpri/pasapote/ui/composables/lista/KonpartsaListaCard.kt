...
import com.anderpri.pasapote.resources.kokalekua
import com.anderpri.pasapote.resources.sorte_data
import com.anderpri.pasapote.resources.txupinerak
...
private fun HeaderListaCard(konpartsa: Konpartsa) {
    Box(
        modifier = Modifier
            .background(parseHexColor(konpartsa.color))
            .padding(16.dp)
    ) {
        Column(
        ...
        Column {
            Row(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    Text(
                        stringResource(Res.string.sorte_data),
                    ...
                    Text(
                        stringResource(Res.string.kokalekua),
                        style = MaterialTheme.typography.bodySmall
                    )
                ...
                AsyncImage(
                    model = Res.getUri("files/${konpartsa.id}.png"),
            ...
            if (konpartsa.txupineras.isNotEmpty()) {
                ...
                Column {
                    Text(
                        stringResource(Res.string.txupinerak),
                        style = MaterialTheme.typography.bodySmall,
                    )
